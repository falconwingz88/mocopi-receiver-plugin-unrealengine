...
void MocopiDataHandler::ProcessFrameData(std::byte* dataBuffer, int bufferSize)
{
  ...
  uint8_t timecode_hour, timecode_min, timecode_sec, timecode_frame, timecode_frame_rate;
  timecode_hour = timecode_min = timecode_sec = timecode_frame = timecode_frame_rate = 0;

  bool timecode_drop_frame = false;
  ...
  bool success = ConvertBytesToFrameData( bufferSize, dataBuffer, senderIp, senderPort,
                                          frameNum, timeStamp, utcTime,
                                          timecode_hour, timecode_min, timecode_sec, timecode_frame,
                                          timecode_frame_rate, timecode_drop_frame,
                                          numBones, jointIds,
                                          rotX, rotY, rotZ, rotW,
                                          posX, posY, posZ
                                        );
  ...
  mFrameMetaData.timecode.hour = timecode_hour;
  mFrameMetaData.timecode.min = timecode_min;
  mFrameMetaData.timecode.sec = timecode_sec;
  mFrameMetaData.timecode.frame = timecode_frame;
  mFrameMetaData.timecode.frameRate = timecode_frame_rate;
  mFrameMetaData.timecode.dropFrame = timecode_drop_frame;
  mFrameMetaData.numBones = numBones;
...
{
  if (IsMmfBytes(bufferSize, dataBuffer))
  {
